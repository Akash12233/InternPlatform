...
const Footer: React.FC = () => {
  return (
    ...
    <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023-2024 <a href="https://abcoedtech.com" target='_blank' className='text-yellow-900' > AbCoEdTech™</a>. All Rights Reserved.
