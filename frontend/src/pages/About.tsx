...
import { abhishek, akash, aniket } from "../assets"

const About: React.FC = () => {
  document.title = "About us";
  return (
    <section className=" md:p-10 p-5 pb-10 flex md:flex-row flex-col items-center gap-10 justify-between bg-gray-900 text-white"  >
        <div className="md:w-1/2 w-full  mx-auto text-black" >
          <h1 className="text-3xl text-[#eee49d] font-bold" >Our people make us great</h1>
          <p className="text-gray-50">Here at ACubicle we focus on markets where technology, innovation, and capital can unlock long-term value.</p>
        ...
        <div className="md:w-1/2 w-full mt-10 md:mt-2 mx-auto" >
          ...
          <div className="flex gap-5" >
            <img src={aniket} className="w-1/5 object-cover rounded-full h-1/5" alt="Abhishek Bante" />
            <div>
              <h2 className="text-xl font-bold" >Aniket Atkari</h2>
              <p className="text-sm text-slate-50  " >CEO & Founder</p>
              <p className="text-sm text-slate-50  mt-5" >
                Aniket Atkari is CEO and Founder of AbCoEdTech PVT. LTD., ACubicle is subsidary of AbCoEdTech PVT. LTD. for internship education and student's success.
                </p>
              <p className="flex gap-2 mt-5 bg-[#eee49d] rounded-full p-2 w-36" >
                <a href="https://www.linkedin.com/in/aniket-atkari-a81938293/" target="_blank" className="text-sm text-slate-50" ><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 30 30">
                      <path d="M24,4H6C4.895,4,4,4.895,4,6v18c0,1.105,0.895,2,2,2h18c1.105,0,2-0.895,2-2V6C26,4.895,25.105,4,24,4z M10.954,22h-2.95 v-9.492h2.95V22z M9.449,11.151c-0.951,0-1.72-0.771-1.72-1.72c0-0.949,0.77-1.719,1.72-1.719c0.948,0,1.719,0.771,1.719,1.719 C11.168,10.38,10.397,11.151,9.449,11.151z M22.004,22h-2.948v-4.616c0-1.101-0.02-2.517-1.533-2.517 c-1.535,0-1.771,1.199-1.771,2.437V22h-2.948v-9.492h2.83v1.297h0.04c0.394-0.746,1.356-1.533,2.791-1.533 c2.987,0,3.539,1.966,3.539,4.522V22z"></path>
                  </svg>
                </a>
